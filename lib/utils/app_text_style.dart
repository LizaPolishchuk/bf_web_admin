...
class AppTextStyle {
  ...
  static const TextStyle bodyText = TextStyle(color: AppColors.textColor, fontSize: 16, fontWeight: FontWeight.w400);

  static const TextStyle bodyText1 = TextStyle(color: AppColors.textColor, fontSize: 12, fontWeight: FontWeight.w400);
